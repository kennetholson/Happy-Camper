...
var roleArn = 'arn:aws:iam::570224379280:role/lambda_dynamo';
...
sts.assumeRole({
    ...
    if (err) { // an error occurred
        ...
        var lambda = require('../src/camper.js');
        //var event = require('./input.json');
        //var event = require('./getCampgrounds.json');
        //var event = require('./getDetails.json');
        //var event = require('./getPetPolicy.json');
        //var event = require('./getDescription.json');
        //var event = require('./getHelp.json');
        var event = require('./getAmenities.json');
